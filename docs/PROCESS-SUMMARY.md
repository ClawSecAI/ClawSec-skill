# ClawSec: Process Summary

**Hackathon Submission - Simple Overview**

---

## How Users Invoke ClawSec

**Natural Language** - Just say: "Run a security audit" or "Check my OpenClaw for vulnerabilities"  
**Works in Telegram/WhatsApp/Discord** - Regular chat messages, no special commands needed  
**Autonomous Payment** - Agent has its own USDC wallet, signs payments automatically
...
**8 - Payment Finalization:** The Coinbase facilitator broadcasts the signed USDC transaction to the Base blockchain, transfers funds from the agent's wallet to the ClawSec receiving wallet, and records the transaction hash on-chain for permanent verification.
...
|-----------|------------|---------|
| **Client** | OpenClaw Skill (Node.js) | Configuration scanning & data cleaning |
